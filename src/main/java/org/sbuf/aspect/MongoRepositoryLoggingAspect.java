...
@Aspect
@Component
@ConditionalOnExpression("${bfw.aspect.repository.enabled:true} and '${spring.data.mongodb.uri:}' != ''")
public class MongoRepositoryLoggingAspect extends AbstractLoggingAspect {
